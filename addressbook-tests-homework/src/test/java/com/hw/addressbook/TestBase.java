...
public class TestBase {
    ...
    protected void gotoToGroupPage() {
    ...
    protected void fillUserDetails(UserData userData) {
        ...
        wd.findElement(By.name("work")).sendKeys(userData.getPhoneWork());
